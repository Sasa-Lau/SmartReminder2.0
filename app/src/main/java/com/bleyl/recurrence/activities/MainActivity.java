...
public class MainActivity extends AppCompatActivity implements ReminderAdapter.RecyclerListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //#Below code is for checking the list of service in your phone String enabledListeners carry the service list.

//         enabledListeners = Settings.Secure.getString(getApplicationContext().getContentResolver(),
//                "enabled_notification_listeners");
//
//        new Handler(Looper.getMainLooper()).post(new Runnable() { // Tried new Handler(Looper.myLopper()) also
//            @Override
//            public void run() {
//                Toast.makeText(getApplicationContext(),enabledListeners, Toast.LENGTH_LONG).show();
//////                Log.d(TAG,enabledListeners);
//////                Log.i(TAG,enabledListeners);
//////                Log.w(TAG,enabledListeners);
//////                Log.e(TAG,enabledListeners);
//            }
//        });
